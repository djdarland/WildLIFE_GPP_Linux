...
long long c_isa_subsort();
long long isValue(ptr_psi_term p);
long long c_glb();
long long c_lub();
void insert_type_builtins();
long long isSubTypeValue(ptr_psi_term arg1,ptr_psi_term arg2); // REV401PLUS changed to long long
// from built_ins.c
...
long long c_abort();
long long abort_life(int nlflag);
long long pred_clause(ptr_psi_term t, long long r, ptr_psi_term  g);
void global_error_check(ptr_node n,long long *error,long long *eval2); // REV401PLUS ->long long
void global_tree(ptr_node n);
void global_one(ptr_psi_term t);
void persistent_error_check(ptr_node n,long long *error);  // REV401PLUS ->long long
void persistent_tree(ptr_node n);
void persistent_one(ptr_psi_term t);
long long hidden_type(ptr_definition t);
ptr_psi_term collect_symbols(long long sel);
ptr_node one_attr();
ptr_psi_term new_psi_term(long long numargs,ptr_definition typ,ptr_psi_term **a1,ptr_psi_term **a2);
...
void init_copy();
void clear_copy();
void insert_translation(ptr_psi_term a,ptr_psi_term b,long long info);
ptr_psi_term translate(ptr_psi_term a,long long **infoptr);
...
long long List_EnumFrom (RefListHeader header,Ref atom,RefListEnumProc proc,Ref closure);
long long List_Enum (RefListHeader header,RefListEnumProc proc,Ref closure);
long long List_EnumBackFrom (RefListHeader header,Ref atom, RefListEnumProc	proc, Ref  closure);
...
void fetch_def_lazy(ptr_psi_term u, ptr_definition old1, ptr_definition old2,    ptr_node old1attr, ptr_node old2attr, long long old1stat, long long old2stat);
...
long long trail_condition(psi_term *Q);


// from lub.c

ptr_int_list appendIntList(ptr_int_list tail,ptr_int_list more);
void mark_ancestors(ptr_definition def, long long *flags);
...
long long make_public(ptr_psi_term term,long long wl_bool);
void traverse_tree(ptr_node n,int flag);
long long c_public();
long long c_private();
long long c_display_modules();
long long c_display_persistent();
...
long long c_private_feature();     
ptr_definition update_feature(ptr_module module, char *feature);
long long all_public_symbols();
// from parser.c

int bad_psi_term(ptr_psi_term t);
void show(long long limit);
void push(psi_term tok,long long prec,long long op);
long long pop(ptr_psi_term tok,long long *op);
long long look();
long long precedence(psi_term tok,long long typ);
...
void print_operator_kind(FILE *s,long long kind);
...
long long opcheck(ptr_psi_term t,long long *prec,long long *type);
...
#ifndef NORAW
long long c_begin_raw ();
long long c_get_raw ();
long long c_put_raw ();
long long c_end_raw ();
long long c_in_raw ();
long long c_window_flag ();
long long c_reset_window_flag ();
...
long long get_arg (ptr_psi_term g, ptr_psi_term *arg, char *number);
// from token.c
...
long long open_output_file(char *file);
long long read_char();
...
void read_name(ptr_psi_term tok,long long ch,long long (*f)(),ptr_definition typ);
...
long long count_sorts(long long c0);
void clear_coding();
void least_sorts();
void all_sorts();
...
void encode_types();
void print_codes();
long long glb_value(long long result,long long f,GENERIC c,GENERIC value1,GENERIC value2, GENERIC *value);
long long glb_code(long long f1,GENERIC c1,long long f2,GENERIC c2,long long *f3,GENERIC *c3);
long long glb(ptr_definition t1,ptr_definition t2,ptr_definition  *t3,ptr_int_list *c3);
...
void x_set_gc (Display *display,GC gc,long long function,unsigned long long color,long long linewidth,Font font);
void x_record_line (ListHeader *displaylist,Action action,long long x0,long long y0,long long x1,long long y1,unsigned long long function,unsigned long long color,unsigned long long linewidth);
void x_record_arc (ListHeader *displaylist,Action action,long long x,long long y,long long width,long long height,long long startangle,long long arcangle,unsigned long long function,unsigned long long  color,unsigned long long linewidth);

void x_record_rectangle (ListHeader *displaylist,Action action,long long x,long long y,long long width,long long height,unsigned long long function,unsigned long long color,unsigned long long linewidth);

void x_record_polygon (ListHeader *displaylist,Action action,XPoint *points,long long npoints,unsigned long long function,unsigned long long color,unsigned long long linewidth);


void x_record_string (ListHeader *displaylist,Action action,long long x,long long y,char *str,Font font,unsigned long long function,unsigned long long color);
...
// long long list_is_nil(ptr_psi_term(lst));
...
ptr_psi_term list_cdr(ptr_psi_term lst);
ptr_psi_term list_car(ptr_psi_term lst);
void bk_stack_add_int_attr(ptr_psi_term t, char *attrname, long long value);
void bk_change_psi_attr(ptr_psi_term t,char *attrname, ptr_psi_term value);
long long unify_int_result(ptr_psi_term t, long long v);
long long GetIntAttr(ptr_psi_term psiTerm, char *attributeName);
ptr_psi_term GetPsiAttr( ptr_psi_term psiTerm,char *attributeName);
long long xcOpenConnection();
long long xcDefaultRootWindow();
long long xcGetConnectionAttribute();
long long xcGetScreenAttribute();
long long xcCloseConnection();
long long xcCreateSimpleWindow();
long long xcSetStandardProperties();
long long xcGetWindowGeometry();
long long xcGetWindowAttribute();
long long xcSetWindowGeometry();
long long xcMoveWindow();
long long xcSetWindowAttribute();
long long xcMapWindow();
long long xcRaiseWindow();
long long xcUnmapWindow();
long long xcMapSubwindows();
long long xcUnmapSubwindows();
long long xcClearWindow();
long long xcResizeWindowPixmap();
long long xcSelectInput();
long long xcRefreshWindow();
long long xcPostScriptWindow();
long long xcDestroyWindow();
long long xcCreateGC();
long long xcGetGCAttribute();
long long xcSetGCAttribute();
long long xcDestroyGC();
long long xcRequestColor();
long long xcRequestNamedColor();
long long xcFreeColor();
long long xcDrawLine();
long long xcDrawArc();
long long xcDrawRectangle();
long long xcFillRectangle();
long long xcFillArc();
long long xcPointsAlloc();
long long xcCoordPut();
long long xcPointsFree();
long long xcDrawPolygon();
long long xcFillPolygon();
long long xcLoadFont();
long long xcUnloadFont();
long long xcDrawString();
long long xcDrawImageString();
long long xcStringWidth();
long long xcSync();
// long long list_is_nil(ptr_psi_term lst);
// ptr_psi_term list_cdr( ptr_psi_term lst);
// ptr_psi_term list_car(ptr_psi_term lst);
...
long long map_funct_over_list(ptr_psi_term lst, long long(*proc)(), long long *closure);
long long map_funct_over_cars(ptr_psi_term lst, long long(*proc)(), long long *closure);
void list_remove_value(ptr_psi_term lst, ptr_psi_term value);
long long xcGetEvent();
long long xcFlushEvents();
long long xcQueryPointer();
void x_setup_builtins();
long long x_read_stdin_or_event(long long *ptreventflag);
long long x_exist_event();
void x_destroy_window(Display *display,Window window);
void x_show_window(Display *display,long long window);
void x_hide_window(Display *display, long long window);
void x_show_subwindow(Display *display, long long window);
void x_hide_subwindow(Display *display, long long window);
long long xcQueryTextExtents();
long long x_postscript_window(Display *display,Window window,ListHeader *displaylist,char *filename);
#endif
