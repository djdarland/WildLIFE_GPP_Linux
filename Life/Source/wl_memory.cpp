...
#define assert(N)
#endif
void wl_memory::print_undo_stack()
{
...
long long wl_memory::bounds_undo_stack()
...
*/
long long wl_memory::unchecked(GENERIC *p, long long len)
// GENERIC *p; 
// long long len;
{
  GENERIC addr;
...
*/
void wl_memory::check_string (GENERIC *s)
// GENERIC *s;
{
  GENERIC addr;
  long long value;
...
*/
void wl_memory::check_bytedata(GENERIC *s)
//     GENERIC *s;
{
  GENERIC addr;
  long long value;
...
*/
void wl_memory::check_code(ptr_int_list *c)
// ptr_int_list *c;
{
...
*/
void wl_memory::check_pair_list(ptr_pair_list *p)
// ptr_pair_list *p;
{  
...
*/
void wl_memory::check_triple_list(ptr_triple_list *p)
// ptr_triple_list *p;
{  
...
*/
void wl_memory::check_kids(ptr_int_list *c)
// ptr_int_list *c;
{
  while (unchecked((GENERIC*)c,sizeof(int_list))) {
...
*/
void wl_memory::check_operator_data(ptr_operator_data *op)
...
*/
void wl_memory::check_module_list(ptr_int_list *c)    /*  RM: Jan 12 1993  */
//     ptr_int_list *c;
{
  while (unchecked((GENERIC*)c,sizeof(int_list))) {
...
*/
void wl_memory::check_module_tree(ptr_node *n)    /*  RM: Jan 13 1993  */
//     ptr_node *n;
{
...
/******** CHECK_MODULE(m) 
	  Checks a module.
*/
void wl_memory::check_module(ptr_module *m)        /*  RM: Jan 12 1993  */
//     ptr_module *m;
{
...
/******** CHECK_KEYWORD(k)
	  Checks a keyword.
*/
void wl_memory::check_keyword(ptr_keyword *k) 
//     ptr_keyword *k;
{
...
*/
void wl_memory::check_definition_list()
{
  ptr_definition *d;
...
*/
void wl_memory::check_def_code(ptr_definition *d)
// ptr_definition *d;
{  
  if (unchecked((GENERIC*)d,sizeof(definition)))
    check_code(&((*d)->code));
...
*/
void wl_memory::check_def_rest(ptr_definition *d)
// ptr_definition *d;
{
  if (*d) {
    check_keyword(&((*d)->keyword)); /*  RM: Jan 12 1993  */
...
*/
void wl_memory::check_type_disj(ptr_int_list *p)
// ptr_int_list *p;
{  
...
*/
void wl_memory::check_resid(ptr_residuation *r)
// ptr_residuation *r;
{
  ptr_int_list code;
  ptr_list *l;
...
*/
void wl_memory::check_resid_block(ptr_resid_block *rb)
// ptr_resid_block *rb;
{
  if (*rb) {
...
/******** CHECK_PSI_TERM(t)
	  Explore a psi_term.
*/
void wl_memory::check_psi_term(ptr_psi_term *t)
// ptr_psi_term *t;
{
  ptr_list *l;
...
*/
void wl_memory::check_attr(ptr_node *n)
// ptr_node *n;
{
...
*/
void wl_memory::check_gamma_rest()
{
  long long i;
...
*/
void wl_memory::check_choice_structs(ptr_choice_point *c)
//     ptr_choice_point *c;
{
...
void wl_memory::check_choice(ptr_choice_point *c)
//     ptr_choice_point *c;
{
  while(*c) {
...
*/
void wl_memory::check_var(ptr_node *n)
// ptr_node *n;
{
  if (unchecked((GENERIC*)n,sizeof(node))) {
    check_var(&((*n)->left));
...
void wl_memory::print_gc_info(long long timeflag)
// long long timeflag;
{
...
{
  long long t1 = sizeof(mem_base)*(stack_pointer-mem_base);
  return t1;
}
long long wl_memory::bi_sys_t2()
{
  long long t2 = sizeof(mem_base)*(mem_limit-heap_pointer);
  return t2;
}
long long wl_memory::bi_sys_t3()
{
  long long t3 = sizeof(mem_base)*(mem_limit-mem_base);
  return t3;
}
GENERIC wl_memory::heap_pointer_val()
{
  return heap_pointer;
}
GENERIC wl_memory::mem_base_val()
{
  return mem_base;
}
GENERIC wl_memory::mem_limit_val()
{
  return mem_limit;
}
